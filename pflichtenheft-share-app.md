...
| `applicationId` | `io.github.ollrich.scatterto` |
| Sprache | Kotlin |
...
**Mastodon**
- Eingabefelder: Instanz-URL (z. B. `https://norden.social`) und Access Token.
...
**Bluesky**
- Eingabefelder: Handle/Identifier (z. B. `ollri.ch`) und **App Password** (nicht das Hauptpasswort; in den Bluesky-Einstellungen erzeugt).
